...
<!-- MARKUP ////////////////////////////////////////////////////// -->
<dialog id="social-media-modal" class="covering-modal" open={open}>
  <div on:click={closeModal} class="background"></div>
  <div class="container">
    <section>
      <h3>Check us Out</h3>
      <ul>
      ...
      <button on:click={closeModal} class="modal-closer-button" type="button">
        <svg class="inline-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
...
#social-media-modal a {
  width: 60px;
  height: 50px;
}

#social-media-modal ul svg {
  width: 2rem;
}
